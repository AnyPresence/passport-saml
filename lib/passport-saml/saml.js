...
SAML.prototype.generateAuthorizeRequest = function (req, isPassive, callback) {
  ...
  .then(function(){
    ...
    if (self.options.privateCert) {
      // TODO: Cert sign and create XML nodes here
    }
...
SAML.prototype.getAuthorizePayload = function(req, callback) {
  ...
  self.generateAuthorizeRequest(req, self.options.passive, function(err, request) {
    ...
    // var base64 = request.toString('base64');
    ...
    callback(null, url.format(target), bufferRequest.toString('base64'));
  });
};
